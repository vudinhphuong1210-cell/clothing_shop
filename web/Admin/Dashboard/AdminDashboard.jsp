            ...
            <body class="container-fluid p-4">
                ...
                <div class="main-content">
                    ...
                    <form method="get" class="d-flex mb-4 align-items-center">
                        <input type="number" name="year" min="2000" max="2100" placeholder="Year" value="${param.year}"
                            class="form-control me-2" style="width:120px;" />
                        <button type="submit" formaction="${pageContext.request.contextPath}/AdminDashboard"
                            class="btn btn-primary me-2">🔄 Load Dashboard Data</button>
                        <button type="submit" formaction="${pageContext.request.contextPath}/ExportRevenue"
                            class="btn btn-success">⬇️ Export Revenue (CSV)</button>
                    </form>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <c:choose>
                                <c:when test="${not empty param.year and empty revenueByYear}">
                                    <div
                                        class="alert alert-warning h-100 d-flex align-items-center justify-content-center">
                                        Năm ${param.year} không có dữ liệu doanh thu.
                                    </div>
                                </c:when>
                                <c:otherwise>
                    ...
                    <%-- Top 10 bán chạy --%>
                                                            ...
                                                            <%-- Tên sản phẩm + ảnh --%>
                                                                <td>
                                                                    <div class="prod-info">
                                                                        ...
                                                                        <div>
                                                                            <div class="prod-name">${item.productName}
                                                                            </div>
                                                                            <div class="prod-cat">${item.categoryName}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <%-- Thanh progress bar --%>
                                                                    <td>
                                                                        <div class="bar-wrap">
                                                                            ...
                                                                            <span
                                                                                class="bar-num">${item.totalSold}</span>
                                                                        </div>
                                                                    </td>
                                                                    <%-- Giá --%>
                                                                        <td>
                        ...
                        <script>
                            // ===== REVENUE =====
                            <c:if test="${empty param.year or not empty revenueByYear}">
                                <c:choose>
                                    <c:when test="${not empty revenueByYear}">
        // Build from revenueByYear
                                        const revenueLabels = [
                                        <c:forEach items="${revenueByYear}" var="e" varStatus="s">
