    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .toolbar { display: flex; justify-content: space-between; align-items: center;
                   ...
                   box-shadow: 0 1px 4px rgba(0,0,0,.08); margin-bottom: 20px; flex-wrap: wrap; gap: 10px; }
        .toolbar form { display: flex; gap: 10px; align-items: center; }
        .toolbar select, .toolbar button, .btn {
            padding: 8px 16px; border-radius: 6px; border: 1px solid #ddd;
            font-size: 14px; cursor: pointer; }
        .btn-primary { background: #4f46e5; color: #fff; border-color: #4f46e5; text-decoration: none; display: inline-block; }
        ...
        .stat-card { background: #fff; padding: 16px 24px; border-radius: 10px;
        ...
        .stat-card.inactive .num { color: #f59e0b; }
        ...
        .prod-img { width: 48px; height: 48px; object-fit: cover;
                    border-radius: 8px; border: 1px solid #eee; }
        .no-img { width: 48px; height: 48px; background: #f3f4f6;
...
<div class="container">
    ...
    <div class="toolbar">
        ...
        <div style="display:flex; gap:10px;">
            <a href="AdminProduct?action=inventory" class="btn btn-primary btn-sm">📊 Xem tồn kho</a>
        ...
        <table>
            ...
            <c:forEach items="${products}" var="p">
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${not empty p.status and p.status.name() eq 'ACTIVE'}">
