...
public class OrderDAO extends DBContext {
    ...
    public Order getOrderByIdAndCustomer(int orderId, int customerId) {
        String sql = "SELECT * FROM [Order] WHERE OrderId = ? AND CustomerId = ?";
    ...
    public List<OrderDetail> getOrderDetails(int orderId) {
        ...
        String sql = "SELECT od.*, p.ProductName FROM OrderDetail od JOIN Product p ON od.ProductId = p.ProductId WHERE od.OrderId = ?";
    ...
    public Order getOrderById(int orderId) {
        String sql = "SELECT * FROM [Order] o JOIN Payment p on o.OrderId = p.OrderId WHERE o.OrderId = ?";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (ts != null) {
                    order.setOrderDate(tsUpdate.toLocalDateTime());
                }
                order.setPaymentStatus(rs.getString("PaymentStatus"));
                return order;
            }
